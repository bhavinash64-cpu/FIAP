...
//
// Since 20260721090000 a submission also carries per-answer metadata — the
...
async function insertWithFallback(
  ...
  try {
    ...
    console.warn(`${table}: metadata columns absent, writing legacy row set. Apply migration 20260721090000.`);
