...
const IRI: Instrument = {
  ...
  items: [
    { en: "I daydream and fantasize, with some regularity, about things that might happen to me.", te: "నాకు జరగబోయే విషయాల గురించి నేను తరచుగా కలలు కంటూ ఊహించుకుంటాను." },
    { en: "I often have tender, concerned feelings for people less fortunate than me.", te: "నా కంటే తక్కువ అదృష్టవంతులైన వారి పట్ల నాకు తరచుగా మృదువైన, శ్రద్ధగల భావాలు కలుగుతాయి." },
    { en: "I sometimes find it difficult to see things from the other person's point of view.", te: "ఎదుటివారి దృక్కోణం నుండి విషయాలను చూడటం నాకు కొన్నిసార్లు కష్టంగా అనిపిస్తుంది." },
    { en: "Sometimes I don't feel very sorry for other people when they are having problems.", te: "ఇతరులు సమస్యల్లో ఉన్నప్పుడు కొన్నిసార్లు నాకు వారి పట్ల పెద్దగా జాలి కలగదు." },
    { en: "I really get involved with the feelings of the characters in a novel.", te: "నవలలోని పాత్రల భావాలతో నేను నిజంగా మమేకమవుతాను." },
    { en: "In emergency situations, I feel apprehensive and ill-at-ease.", te: "అత్యవసర పరిస్థితుల్లో నాకు ఆందోళనగా, అసౌకర్యంగా అనిపిస్తుంది." },
    { en: "I am usually objective when I watch a movie or play, and I don't often get completely caught up in it.", te: "సినిమా లేదా నాటకం చూసేటప్పుడు నేను సాధారణంగా నిష్పక్షపాతంగా ఉంటాను, అందులో పూర్తిగా లీనమవను." },
    { en: "I try to look at everybody's side of a disagreement before I make a decision.", te: "నిర్ణయం తీసుకునే ముందు, భిన్నాభిప్రాయంలో ప్రతి ఒక్కరి వైపు నుండి చూడటానికి ప్రయత్నిస్తాను." },
    { en: "When I see someone being taken advantage of, I feel kind of protective towards them.", te: "ఎవరైనా మోసానికి గురవుతుండటం చూసినప్పుడు, వారిని కాపాడాలనే భావన నాకు కలుగుతుంది." },
    { en: "I sometimes feel helpless when I am in the middle of a very emotional situation.", te: "చాలా భావోద్వేగకరమైన పరిస్థితి మధ్యలో ఉన్నప్పుడు కొన్నిసార్లు నాకు నిస్సహాయంగా అనిపిస్తుంది." },
    { en: "I sometimes try to understand my friends better by imagining how things look from their perspective.", te: "నా స్నేహితుల దృక్కోణం నుండి విషయాలు ఎలా కనిపిస్తాయో ఊహించుకుని, వారిని బాగా అర్థం చేసుకోవడానికి కొన్నిసార్లు ప్రయత్నిస్తాను." },
    { en: "Becoming extremely involved in a good book or movie is somewhat rare for me.", te: "మంచి పుస్తకం లేదా సినిమాలో పూర్తిగా లీనమవడం నాకు కొంతవరకు అరుదు." },
    { en: "When I see someone get hurt, I tend to remain calm.", te: "ఎవరైనా గాయపడటం చూసినప్పుడు, నేను ప్రశాంతంగా ఉండగలుగుతాను." },
    { en: "Other people's misfortunes do not usually disturb me a great deal.", te: "ఇతరుల దురదృష్టాలు సాధారణంగా నన్ను పెద్దగా కలవరపెట్టవు." },
    { en: "If I'm sure I'm right about something, I don't waste much time listening to other people's arguments.", te: "ఒక విషయంలో నేను సరైనవాడినని నమ్మకంగా ఉంటే, ఇతరుల వాదనలు వినడానికి ఎక్కువ సమయం వృథా చేయను." },
    { en: "After seeing a play or movie, I have felt as though I were one of the characters.", te: "నాటకం లేదా సినిమా చూసిన తర్వాత, నేను అందులోని ఒక పాత్రలా భావించాను." },
    { en: "Being in a tense emotional situation scares me.", te: "ఉద్రిక్త భావోద్వేగ పరిస్థితిలో ఉండటం నన్ను భయపెడుతుంది." },
    { en: "When I see someone being treated unfairly, I sometimes don't feel very much pity for them.", te: "ఎవరైనా అన్యాయానికి గురవుతుండటం చూసినప్పుడు, కొన్నిసార్లు నాకు వారి పట్ల పెద్దగా జాలి కలగదు." },
    { en: "I am usually pretty effective in dealing with emergencies.", te: "అత్యవసర పరిస్థితులను ఎదుర్కోవడంలో నేను సాధారణంగా చాలా సమర్థంగా ఉంటాను." },
    { en: "I am often quite touched by things that I see happen.", te: "నా కళ్ళ ముందు జరిగే విషయాలు తరచుగా నన్ను కదిలిస్తాయి." },
    { en: "I believe that there are two sides to every question and try to look at them both.", te: "ప్రతి విషయానికి రెండు వైపులు ఉంటాయని నేను నమ్ముతాను, రెండింటినీ చూడటానికి ప్రయత్నిస్తాను." },
    { en: "I would describe myself as a pretty soft-hearted person.", te: "నేను చాలా మృదు హృదయం గల వ్యక్తిగా నన్ను వర్ణించుకుంటాను." },
    { en: "When I watch a good movie, I can very easily put myself in the place of a leading character.", te: "మంచి సినిమా చూసేటప్పుడు, ప్రధాన పాత్ర స్థానంలో నన్ను నేను చాలా సులభంగా ఊహించుకోగలను." },
    { en: "I tend to lose control during emergencies.", te: "అత్యవసర సమయాల్లో నేను నియంత్రణ కోల్పోతాను." },
    { en: "When I'm upset at someone, I usually try to put myself in their shoes for a while.", te: "ఎవరిపైనైనా బాధగా ఉన్నప్పుడు, కొద్దిసేపు వారి స్థానంలో నన్ను నేను ఊహించుకోవడానికి సాధారణంగా ప్రయత్నిస్తాను." },
    { en: "When I am reading an interesting story or novel, I imagine how I would feel if the events in the story were happening to me.", te: "ఆసక్తికరమైన కథ లేదా నవల చదువుతున్నప్పుడు, కథలోని సంఘటనలు నాకు జరిగితే నేను ఎలా భావిస్తానో ఊహించుకుంటాను." },
    { en: "When I see someone who badly needs help in an emergency, I go to pieces.", te: "అత్యవసర పరిస్థితిలో సహాయం చాలా అవసరమైన వ్యక్తిని చూసినప్పుడు, నేను కలవరపడిపోతాను." },
    { en: "Before criticizing somebody, I try to imagine how I would feel if I were in their place.", te: "ఎవరినైనా విమర్శించే ముందు, నేను వారి స్థానంలో ఉంటే ఎలా భావిస్తానో ఊహించుకోవడానికి ప్రయత్నిస్తాను." },
  ],
};
