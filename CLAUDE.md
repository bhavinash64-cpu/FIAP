...
| Lane | Owns | Status |
|---|---|---|
| **A · Public assessment** | `src/components/assessment/*`, `src/pages/public/SurveyRunner.tsx`, `src/lib/{answerVisuals,assessmentSession}.ts`, `supabase/functions/submit-response/*`, `src/test/assessment*` | **CLAIMED** |
...
npm test            # vitest
npx tsc --noEmit    # fastest correctness gate
supabase db push
```
